...
public class GameTable extends JTable implements Runnable{
    ...
    public GameTable(int width,int height){
        AbstractTable abstractTable = new AbstractTable(width,height);
    ...
    public void enemyForward(){
        ...
        if (enemyCurrentX>(tableHeight-2)*16){
        ...
        if (enemyCurrentY>(tableWidth-2)*16){
